      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                final updatedTitulo = _tituloController.text.trim();
                final updatedDescripcion = _descripcionController.text.trim();
                final updatedPrecio = double.tryParse(_precioController.text.trim()) ?? 0.0;
